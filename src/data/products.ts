...
const velaDiseno1ImgUrl = "https://raw.githubusercontent.com/Jonathanx55/Ysabel-Rosher/main/src/assets/images/Vela%20con%20Dise%C3%B1o%201.png";
const velaDiseno2ImgUrl = "https://raw.githubusercontent.com/Jonathanx55/Ysabel-Rosher/main/src/assets/images/Vela%20con%20Dise%C3%B1o%202.jpg";
...
export const PRODUCTS: Product[] = [
  ...
  { id: 4, name: "Vela Artesanal con Diseño Floral", price: 1450, category: "Velas", img: velaDiseno1ImgUrl, desc: "Hermosa vela artesanal decorativa con delicados detalles en relieve. Perfecta para embellecer y aromatizar tus espacios con un toque de elegancia.", media: [{ type: 'image', url: velaDiseno1ImgUrl }] },
  ...
  { id: 6, name: "Vela Decorativa de Rosas", price: 1450, category: "Velas", img: velaDiseno2ImgUrl, desc: "Vela elaborada a mano con un encantador diseño de rosas. Ideal para regalar o para crear un ambiente romántico y acogedor en tu hogar.", media: [{ type: 'image', url: velaDiseno2ImgUrl }] },
