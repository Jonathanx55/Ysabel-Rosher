  ...
  const sidebarContent = (
    <>
      <div className="p-6 text-center border-b border-white/10 mb-4">
        <div className="w-10 h-10 border border-gold-400 flex items-center justify-center rounded-none bg-black text-gold-400 font-serif text-lg mx-auto mb-3">
          YR
        </div>
        <h2 className="text-lg font-serif text-white uppercase tracking-widest">Ysabel Rocher</h2>
    ...
    <div className="min-h-screen flex bg-white overflow-hidden">
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 h-16 bg-black border-b border-gold-400/20 z-50 flex items-center justify-between px-4">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 border border-gold-400 flex items-center justify-center bg-black text-gold-400 font-serif text-sm">
            YR
          </div>
