      ...
      <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-black/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-4 group">
            ...
            */}
            <div translate="no" className="w-12 h-12 border border-gold-400 flex items-center justify-center rounded-none bg-black text-gold-400 font-serif text-xl group-hover:bg-gold-500 group-hover:text-black group-hover:border-black transition-colors duration-300">
              YR
            </div>
