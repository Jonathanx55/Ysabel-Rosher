  ...
  return (
    <div className="flex flex-col bg-white">
      ...
      <div className="flex flex-col w-full bg-[#0a0a0a]">
        {/* Image wrapper - never crops, maintains aspect ratio */}
        <div className="relative w-full">
          <img src="https://raw.githubusercontent.com/Jonathanx55/Ysabel-Rosher/main/src/assets/images/Imagen%20Principal.png" alt="Hero Banner" className="w-full h-auto block" />
          <div className="absolute inset-0 bg-black/30"></div>
          
          {/* Desktop Text Overlay (Hidden on Mobile) */}
          <div className="hidden md:flex absolute inset-0 flex-col items-center justify-center text-center px-4 max-w-4xl mx-auto z-10">
            ...
            <p className="text-lg md:text-xl text-white/95 max-w-2xl mx-auto mb-10 font-light drop-shadow-md">
              Ysabel Rosher ofrece una colección exclusiva de productos artesanales diseñados para armonizar tu hogar y tu piel.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/catalog" className="bg-gold-400 text-black px-8 py-4 rounded-none text-sm uppercase tracking-widest hover:bg-gold-500 transition-colors duration-300 shadow-lg">
                Ver Catálogo
              </Link>
              <Link to="/about" className="bg-transparent border border-white text-white px-8 py-4 rounded-none text-sm uppercase tracking-widest hover:bg-white hover:text-black transition-colors duration-300 shadow-lg">
                Conócenos
              </Link>
            </div>
          </div>
        ...
        <div className="md:hidden flex flex-col items-center text-center px-6 py-12 z-10 bg-[#0a0a0a]">
          <h1 className="text-3xl font-serif text-white mb-4 tracking-wide">
            Esencias y Detalles <span className="text-gold-400">Artesanales</span>
          </h1>
          <p className="text-sm text-white/80 max-w-2xl mx-auto mb-8 font-light">
            Ysabel Rosher ofrece una colección exclusiva de productos artesanales diseñados para armonizar tu hogar y tu piel.
          </p>
          <div className="flex flex-col w-full gap-4 max-w-xs mx-auto">
            <Link to="/catalog" className="bg-gold-400 text-black px-6 py-4 rounded-none text-xs font-medium uppercase tracking-widest hover:bg-gold-500 transition-colors duration-300 text-center shadow-md">
              Ver Catálogo
            </Link>
            <Link to="/about" className="bg-transparent border border-white text-white px-6 py-4 rounded-none text-xs font-medium uppercase tracking-widest hover:bg-white hover:text-black transition-colors duration-300 text-center">
              Conócenos
            </Link>
          </div>
        </div>
      ...
      <div className="bg-black py-32 relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-white/80 leading-relaxed mb-10 text-lg font-light">
            Cada producto de <span className="text-gold-400 font-serif">Ysabel Rosher</span> es una declaración de cuidado y conexión. 
