  ...
  return (
    <div className="flex flex-col bg-white">
      ...
      <div className="relative h-[80vh] w-full flex items-center justify-center overflow-hidden">
        <img src="https://raw.githubusercontent.com/Jonathanx55/Ysabel-Rosher/main/src/assets/images/Imagen%20Principal.png" alt="Hero Banner" className="absolute inset-0 w-full h-full object-cover object-[center_30%]" />
