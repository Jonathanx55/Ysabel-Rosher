          ...
          <form className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input type="text" defaultValue="Ysabel Rocher" className="w-full border border-stone-300 rounded-md px-3 py-2 focus:ring-1 focus:ring-stone-500 focus:outline-none" />
              </div>
              <div>
                <label className="block text-sm font-medium text-stone-700 mb-1">Correo de Contacto</label>
                <input type="email" defaultValue="info@ysabelrocher.com" className="w-full border border-stone-300 rounded-md px-3 py-2 focus:ring-1 focus:ring-stone-500 focus:outline-none" />
              </div>
            </div>
            <div>
              <label className="block text-sm font-medium text-stone-700 mb-1">Descripción Corta</label>
              <textarea rows={3} className="w-full border border-stone-300 rounded-md px-3 py-2 focus:ring-1 focus:ring-stone-500 focus:outline-none" defaultValue="Elegancia y alta costura al alcance de tu mano."></textarea>
            </div>
            <div className="pt-2">
