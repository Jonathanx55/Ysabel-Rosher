  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20 bg-white">
      ...
      <div className="mx-auto text-lg text-black/70 leading-relaxed font-light">
        <p className="mb-8">
          Ysabel Rocher nació de una profunda conexión con la naturaleza y el deseo de llevar el bienestar al hogar. 
        ...
        <p className="text-center mb-8">
          Te invitamos a explorar nuestras colecciones y a ser parte de la familia Ysabel Rocher. 
        </p>
      </div>
    </div>
  );
